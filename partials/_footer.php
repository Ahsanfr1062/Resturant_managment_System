        ...
        <div class="lg:w-1/4 md:w-1/2 w-full px-4">
          ...
          <div class="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
            ...
            <div class=" flex text-center justify-center mt-4 ml-6">
              <a href="#"
                class="block w-full rounded bg-[#C8A97E] px-12 py-3 text-sm font-medium text-white shadow hover:bg-transparent hover:text-[#C8A97E] hover:border-solid hover:border-[1px] hover:border-[#C8A97E] focus:outline-none focus:ring active:bg-rose-500 sm:w-auto">
                Subscribe
              </a>
            </div>
          </div>
